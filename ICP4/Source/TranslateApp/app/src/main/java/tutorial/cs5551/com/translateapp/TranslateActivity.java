...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spin=(Spinner) findViewById(R.id.spn_lang);
        ArrayAdapter adapter=ArrayAdapter.createFromResource(this, R.array.str_lang, R.layout.support_simple_spinner_dropdown_item);
