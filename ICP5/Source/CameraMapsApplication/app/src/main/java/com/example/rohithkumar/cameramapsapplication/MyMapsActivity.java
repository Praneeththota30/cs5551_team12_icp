    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(myLocation!=null){
            ...
            MarkerOptions currentLocationMarker = new MarkerOptions()
                    .position(Location)
                    .title("Location : Latitude : "+myLocation.getLatitude()+ " Longitude : "+myLocation.getLongitude());
            ...
            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(Location, 14), 1500, null);
        }
    }
}